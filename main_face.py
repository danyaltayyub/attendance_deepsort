...
class VideoTracker(object):
    ...
    def __enter__(self):
        ...
        # if self.args.face_database is not None:
        #     data = torch.load(self.args.face_database)
        #     self.face_embeddings = data[0]
    ...
    def image_track(self, im0):
        ...
        if boxes is not None and len(boxes):
            ...
            # ****************************** deepsort ****************************
            outputs, name = self.deepsort.update(bbox_xywh, confs, im0)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--record_attendance', default= True, help= 'Records attendance of people entering the stream')
